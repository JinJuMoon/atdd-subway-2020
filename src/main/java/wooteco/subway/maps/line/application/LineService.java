...
public class LineService {
    ...
    public int findMostExpensiveFare(final List<Long> ids) {
        List<Integer> extraFares = findLinesById(ids).stream()
    ...
    private List<Line> findLinesById(final List<Long> ids) {
